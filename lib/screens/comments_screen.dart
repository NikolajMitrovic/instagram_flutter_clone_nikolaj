...
import 'package:instagram_flutter/resources/firestore_methode.dart';
...
class _CommentsScreenState extends State<CommentsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        // stream: FirebaseFirestore.instance.collection('posts').doc(widget.postId['postId']).collection('comments').snapshots(),
